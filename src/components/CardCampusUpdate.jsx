  ...
  return (
    <div className="flex w-full">
      ...
      <div className="flex flex-col justify-between p-4">
        <h1 className="text-xl font-medium">Acquiring Temporary Medals from FISU World University Games 2021, Indonesian Students Win Two Medals in Wushu Sports</h1>
